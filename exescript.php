    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><strong>Script Panel</strong>
                    </h2>
                    <hr>                   
                    ...
                    <!-- form role="form" action="?version=${version:=1}" method="POST" enctype="application/x-www-form-urlencoded" -->
                        <div class="row">
                         <!--     <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12">
                                <label>Output</label>
                                <div class="form-control" rows="6" name="message" style="height:auto;!important"><? echo system($command); ?></div>
                            </div>
                          <!--  <div class="form-group col-lg-12">
